...
public class Formulario_de_usuarios {
   ...
   /*public static void main(String[] args) {
        // Crear el formulario y mostrar la interfaz
        JFrame frame = new JFrame("Formulario de Usuarios");
        frame.setContentPane(new Formulario_de_usuarios().panel1); // Usar el nombre correcto de la clase
